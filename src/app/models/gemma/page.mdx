...
<Header model="gemma">Gemma LLMs family</Header>
...
Please watch this [3 ways to run Gemma’s latest version](https://www.youtube.com/watch?v=AfssOYdS0j4) video from Google to start building your own applications with Gemma 3 right now.
...
Google has created dedicated YouTube playlist for [Gemma related](https://www.youtube.com/playlist?list=PLOU2XLYxmsIIuDZXFpPEM85OReP_NV3tI) materials and recently (April 2025) host a _Gemma Developer Day Paris_ event, where they shared insights about the Gemma models and their applications. The whole event is available on YouTube [as a playlist](https://www.youtube.com/playlist?list=PLOU2XLYxmsILOkAPDwRqvbiReWbIcLC4k) as well.
