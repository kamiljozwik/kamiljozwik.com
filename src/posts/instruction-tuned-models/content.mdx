...
Have you ever run into terms _"base model"_ and _"instruction-tuned model"_ and had no idea what they meant?
...
- You have a very specific, narrow task that differs significantly from general instruction following.
