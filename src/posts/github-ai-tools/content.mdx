...
There is also a feature called [Copilot Edits](https://code.visualstudio.com/docs/copilot/copilot-edits), but it stays behind with automatic editing of multiple files (agentic coding) e.g. [Cursor](https://www.cursor.com/). All this should change when the functionality available for now in [VS Code Insiders](https://code.visualstudio.com/insiders/) is introduced into the production version of Copilot. If everything works stably and as it [does in this video](https://www.youtube.com/watch?v=C95drFKy4ss), then Copilot can take over the primacy as a programming copilot, making tools like Cursor or [Cline](https://cline.bot/) less relevant.
